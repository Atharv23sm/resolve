...
export default function SignupPage() {
    ...
    return (
        <Suspense fallback={<PageLoading />}>
            <div className="min-h-screen flex justify-center md:items-center py-[12vh] md:py-[20vh] px-[6vw]">
                <div className="h-max flex flex-col md:flex-row justify-center gap-[6vw] md:gap-[8vw] lg:border-8 lg:p-10">
                    ...
                    <form onSubmit={onSubmit} className="flex flex-col gap-4">
                        ...
                        <div className="w-max h-max flex items-center relative">
                            <input type={passwordType} onChange={(e) => setSignupData({ ...signupData, password: e.target.value })} placeholder="password" required minLength={4} maxLength={16} className="auth-input" />
                        ...
                        <button type="submit" disabled={buttonDisabled} className={`w-[250px] p-2 ${!loading && 'bg-[#53f]'} disabled:text-[#fff8]`} >
